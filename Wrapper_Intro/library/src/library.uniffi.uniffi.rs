...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn ffi_library_a699_rustbuffer_alloc(
    size: i32,
...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn ffi_library_a699_rustbuffer_from_bytes(
...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn ffi_library_a699_rustbuffer_free(
...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn ffi_library_a699_rustbuffer_reserve(
    buf: uniffi::RustBuffer,
    additional: i32,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> uniffi::RustBuffer {
...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn ffi_library_a699_string_free(
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_a699_bool_inc_test(
    value: i8,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> i8 {
    ...
    uniffi::deps::log::debug!("library_a699_bool_inc_test");
