...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn ffi_library_c453_rustbuffer_alloc(
    size: i32,
...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn ffi_library_c453_rustbuffer_from_bytes(
...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn ffi_library_c453_rustbuffer_free(
...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn ffi_library_c453_rustbuffer_reserve(
    buf: uniffi::RustBuffer,
    additional: i32,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> uniffi::RustBuffer {
...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn ffi_library_c453_string_free(
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_bool_inc_test(
    value: i8,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> i8 {
    ...
    uniffi::deps::log::debug!("library_c453_bool_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_i8_inc_test(
    value: i8,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> i8 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_i8_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_i16_inc_test(
    value: i16,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> i16 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_i16_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_i32_inc_test(
    value: i32,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> i32 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_i32_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_i64_inc_test(
    value: i64,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> i64 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_i64_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_u8_inc_test(
    value: u8,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> u8 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_u8_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_u16_inc_test(
    value: u16,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> u16 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_u16_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_u32_inc_test(
    value: u32,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> u32 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_u32_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_u64_inc_test(
    value: u64,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> u64 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_u64_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_float_inc_test(
    value: f32,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> f32 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_float_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_double_inc_test(
    value: f64,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> f64 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_double_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_string_inc_test(
    value: uniffi::RustBuffer,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> uniffi::RustBuffer {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_string_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_byref_inc_test(
    value: uniffi::RustBuffer,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> uniffi::RustBuffer {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_byref_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_optional_type_inc_test(
    value: uniffi::RustBuffer,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> uniffi::RustBuffer {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_optional_type_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_vector_inc_test(
    value: uniffi::RustBuffer,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> uniffi::RustBuffer {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_vector_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_hash_map_inc_test(
    value: uniffi::RustBuffer,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> uniffi::RustBuffer {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_hash_map_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_void_inc_test(
    value: i32,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> () {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_void_inc_test");
...
#[doc(hidden)]
#[no_mangle]
pub extern "C" fn library_c453_error_inc_test(
    a: u64,
    b: u64,
    err: &mut uniffi::deps::ffi_support::ExternError,
) -> u64 {
    // If the provided function does not match the signature specified in the UDL
    // then this attempt to call it will not compile, and will give guidance as to why.
    uniffi::deps::log::debug!("library_c453_error_inc_test");
